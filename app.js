...
const ASSETS = {
  sounds: {
    ...
    readyCheckFallback: "assets/sounds/ready-check.wav",
    startFallback: "assets/sounds/start.wav",
    clearFallback: "assets/sounds/clear.wav",
    comboFallback: "assets/sounds/combo.wav",
    victoryFallback: "assets/sounds/victory.wav",
  },
  animations: {
...
function playSound(name) {
  ...
  audio.play().catch(() => {
    const fallback = ASSETS.sounds[`${name}Fallback`];
    if (!fallback) {
      return;
    }
